...
* `py/`
  * `test_met1.py` - тест, который запускает ваши реализации. В нём нужно изменить номер студента на свой.
  * `met1.py` - место для ваших реализаций. Каждая из них должна возвращать списки X и Y аналогично тому же, что и в матлабе.
